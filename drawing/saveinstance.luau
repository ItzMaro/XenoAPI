...
local function synsaveinstance(CustomOptions, CustomOptions2)
	...
	-- 	warn("Zenora Decompiler v3 is already running")
	-- 	return
	-- end
								...
								if PropertyName == "Source" then
									if DecompileIgnoring then -- ? Should this really prevent extraction of the original source if present ?
										...
										if should_decompile then
											...
											then
												value = "-- Server Scripts can only be saved using Zenora Premium" --TODO: Could be not just server scripts in the future
											else
										...
										value = "-- Saved by Zenora Decompiler v3 https://discord.gg/exploitnews \n\n"
									end
								end
		...
		if OPTIONS.ReadMe then
			save_extra(
				...
				"--[[\n"
					...
					.. [[
		Thank you for using Zenora Decompiler v3 https://discord.gg/exploitnews.
